...
const TechStack = () => {
	...
	return (
		<div className="flex flex-wrap justify-evenly bg-neutral p-4 rounded-md gap-2 disappear">
			...
			<Bootstrap className="text-neutral-content hover:text-[#7952B3] transition ease-in-out delay-75 hover:-translate-y-1 hover:scale-110 duration-150" />
			<Tailwindcss className="text-neutral-content hover:text-[#06B6D4] transition ease-in-out delay-75 hover:-translate-y-1 hover:scale-110 duration-150" />
