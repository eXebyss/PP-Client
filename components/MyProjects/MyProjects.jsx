			...
			<div className='hero-content text-center'>
				<div
					...
					<div className='carousel w-full'>
						{props.map((e, i) => (
							<div id={i} className='carousel-item w-full' key={i}>
								<div className='card bg-base-100 shadow-xl'>
									<div className='card-body'>
										<div className='text-primary text-left'>
											{documentToReactComponents(e.fields.projectType)}
										</div>
										<div className={`card-title ${classes.cardTitle}`}>
											{documentToReactComponents(e.fields.projectName)}
										</div>
										<div className='text-left'>
											{documentToReactComponents(e.fields.projectDate)}
										</div>
										...
										<div
											...
											{documentToReactComponents(e.fields.projectTechStack)}
										</div>
										...
										<figure>
											<Image
												...
												alt={e.fields.ppImage1.fields.description}
												width={
													e.fields.ppImage1.fields.file.details.image.width
												}
												height={
