...
export default function Email({ name, email, message, dateString }) {
	return (
		<Html>
			<Head />
			<Preview>Thank you for your 📧❗</Preview>
			<Section style={main}>
				<Container style={container}>
					...
					<Hr style={hr} />
					<Text style={footer}>
						This is automatically sent response for your message.
						You received it, because you successfully sent your
						message to me suing <strong>contact form</strong> on my{' '}
						<Link
						...
						. <strong>NOTE: </strong> no further actions are
						required. If it's necessary or required, I will ret
